...
const RegisterForm = ({ email, handleEmailChange, password, handlePasswordChange, onSubmit, handleModeState, onClose }) => {
  return (
    <StyledRegisterForm>
      <div className={'modal_left'}>
        ...
        <button className={'register_btn'} onClick={onSubmit}>
          Sign up
        </button>
        <div className={'login_block'}>
          Already have an account?
          <button className={'login_btn'} onClick={handleModeState}>
            Sign in
          </button>
        </div>
      </div>
